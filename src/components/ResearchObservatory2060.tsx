...
const DISCIPLINES: Discipline2060[] = [
  {
    ...
    metrics: [
      { label: { en: "Theoretical Rigor", ar: "الرصانة المعرفية" }, value: "Foundational", pct: 95 },
  ...
  },
  {
    ...
    lab: { en: "Cognitive Sovereignty Unit", ar: "وحدة السيادة الإدراكية" },
    metrics: [
      { label: { en: "Algorithmic Autonomy Framework", ar: "إطار الاستقلال الخوارزمي" }, value: "Developing", pct: 90 },
  ...
  },
  {
    ...
    lab: { en: "Conscious Leadership & Civilizational Transformation Unit", ar: "وحدة القيادة الواعية والتحول الحضاري" },
    metrics: [
      { label: { en: "Leadership Immersions", ar: "البرامج التنفيذية" }, value: "08 Tracks", pct: 92 },
      { label: { en: "Decision Soundness", ar: "رشاد القرار" }, value: "Developing", pct: 90 },
    ],
    accentColor: "#7c3aed",
  ...
  },
  {
    ...
    lab: { en: "Knowledge, Theories & Research Unit", ar: "وحدة المعرفة والنظريات والأبحاث" },
    metrics: [
  ...
  },
  {
    ...
    lab: { en: "Thought, Future & Impact Unit", ar: "وحدة الفكر والمستقبل والأثر" },
    metrics: [
      { label: { en: "Ontological Fortitude", ar: "الثبات الوجودي" }, value: "Foundational", pct: 95 },
      { label: { en: "Stress Absorption", ar: "امتصاص الصدمات" }, value: "Resilient", pct: 90 },
    ],
    accentColor: "#d97706",
  ...
  },
  {
    ...
    category: { en: "Macro Strategic Impact", ar: "الأثر الاستراتيجي والعمق الحضاري" },
    desc: {
    ...
    lab: { en: "Thought, Future & Impact Unit", ar: "وحدة الفكر والمستقبل والأثر" },
    metrics: [
      { label: { en: "Vision 2030 Horizons", ar: "آفاق رؤية 2030" }, value: "Foundational", pct: 95 },
      { label: { en: "AICT Prototype Metric", ar: "نموذج مؤشر الرحيمي للتحول" }, value: "Prototype", pct: 90 },
    ],
    accentColor: "#c026d3",
